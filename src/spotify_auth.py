...
class SpotifyAuthenticator:
    ...
    def authenticate(self) -> spotipy.Spotify:
        ...
        try:
            ...
            if token_info:
                ...
                # Warte auf Callback
                code = self.oauth.parse_response_code(input("Enter the URL you were redirected to: "))
    ...
    def authenticate_from_stored_token(self) -> bool:
        ...
        try:
            ...
            # Teste Verbindung
            user_info = self._spotify_client.current_user()
            logger.info(f"Successfully authenticated from stored token as: {user_info['display_name']}")
